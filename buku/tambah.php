        ...
        <div class="col-xs-12 col-sm-12">
            ...
            if (isset($_POST['submit'])) {
                ...
                elseif (empty($stok)) {
                    ...
                    $con = connect_db();
                    $query = "INSERT INTO buku (isbn,judul,idpengarang,stok,gambar) " . " VALUES ('$isbn','$judul','$idpengarang','$stok','$file_name')";
            ...
            <form name="formtambah" method="post" enctype="multipart/form-data" id="formtambah">
                ...
                <div>
                    <label for="gambar">Foto:</label> <input type="file" name="gambar" id="gambar">
                </div>
                <div>
