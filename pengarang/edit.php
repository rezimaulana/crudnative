    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12">
            ...
            <form name="formtambah" method="post" id="formtambah">
                ...
                <div>
                    <label for="nama">Nama:</label> <input type="text" name="nama" id="nama" value="<?= $data['nama'] ?>" size="50" required="required">
                </div>
                <div>
                    <label for="telpon">Email:</label> <input type="text" name="email" id="email" value="<?= $data['email'] ?>" required="required" size="30">
                </div>
                <div>
